...
public class EmpleadoPorComisionConSalarioBase extends Empleado{
    private float montoFijo;
    private int cantVentas;
    private float ValorDeVenta;
    private int porcentajeBruto;

    public EmpleadoPorComisionConSalarioBase(String nombre, String apellido, String te, String cuil, LocalDate fecha){
        setNombre(nombre);
