...
public class ListaDeTarea {
    ...
    private ArrayList<Colaborador>listaColaboradores=new ArrayList<Colaborador>();
    ...
    public boolean BuscarColaborador(Colaborador colaborador){
        boolean bandera=false;
        for (int i = 0; i < listaColaboradores.size(); i++) {
            if (colaborador.equals(listaColaboradores.get(i))){
                bandera=true;
                return bandera;
            }
        }
